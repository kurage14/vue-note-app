...
const { searchResults } = storeToRefs(noteStore); //state (狀態) 跟 getters (計算屬性) 解構賦值，同時保有響應式狀態
const { markedPinned, searchNotes } = noteStore; //actions (方法) 直接解構就行
...
<main id="result" class="container mt-4">
    <div class="row d-flex justify-content-start">
        <div class="col-4 mr-2 mb-4" v-for="note in searchResults">
